...
const SearchBar: React.FC<SearchBarProps> = ({ value, onChange }) => {
    ...
    return (
        <div className="flex gap-4 flex-wrap">
            ...
            <button
                onClick={handleClear}
                className="px-4 py-2 rounded-xl border border-slate-500 bg-secondary text-secondary-foreground hover:-translate-y-1/12 hover:bg-primary hover:text-primary-foreground transition-all duration-300"
            >
                Clear
            </button>
